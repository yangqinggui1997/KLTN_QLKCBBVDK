...
<script>
    $(function () {
        ...
        $('a[class*="cba"]').click(function(){
            $.ajax({
                url: 'http://localhostpublic/audios/sound.mp3',
                type: 'GET',
                error: function()
                {
                    //not exists
...
//            authTransport: 'jsonp',
//            authEndpoint: 'localhosttiep_don'
//        });
            ...
            if(data.thaotac != 'xoa'){
                ...
                if(data.pk != null){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/benh_an_ngoai_tru/lay_ds_pk_da_tn',
                        xhr: function() {
...
//                     Success
            ...
            $.when(ktba(mabn, mapdk)).done(function (){
                if(bnddd == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/benh_an_ngoai_tru/them_moi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_ngoai_tru/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bangoai').on('click', 'button[data-button="btnxoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_ngoai_tru/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_bangoai').on('click','button[data-button="btnsua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_ngoai_tru/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnhuygcv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/xoa',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btngcv').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/them_moi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btningcv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bangoai').on('click', 'button[data-button="btnxemtt"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bangoai').on('click', 'button[data-button="btnxemcdtt"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btncba').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/them_moi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_ngoai_tru/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                            $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách tìm kiếm').tooltip('fixTitle').tooltip('show');
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_ngoai_tru/lay_ds_ba',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                        $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách').tooltip('fixTitle').tooltip('show');
        ...
        $('#custom-nav-profile-tab').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/lay_ds_ck',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnthemthuoc').click(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/kt_ct',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
                ...
                success: function(data) {
                    ...
                    if(data.msg == 'trung')
                    {
                        ...
                        $.ajax({
                            type: 'POST',
                            dataType: "JSON",
                            url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru/them_moi',
                            xhr: function() {
                                var myXhr = $.ajaxSettings.xhr();
                                return myXhr;
                            },
        ...
        $('#tbl_toathuoc').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btncapnhatthuoc').click(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_toathuoc').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru_ct/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnintoathuoc').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnhuytoathuoc').click(function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        function ktcls(maba, macls){
            ...
            return $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/kt_cls_ngoai_tru',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                     Success
        ...
        $('#btnrachidinhcls').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            $.when(ktcls(maba, macls)).then(function (){
                if(flagcls == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/can_lam_sang/them_moi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btnsuacdcls').click(function(){
            ...
            var formData = new FormData();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/can_lam_sang/cap_nhat',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
    ...
    //                     Success
        ...
        $('#tbl_cdcls').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/can_lam_sang/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_cdcls').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function inphieucls(idcls){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function kttt(maba, matt){
            ...
            return $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/kt_tt_ngoai_tru',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            $.when(kttt(maba, matt)).then(function (){
                if(flagtt == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/them_moi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btnsuacdtt').click(function(){
            ...
            var formData = new FormData();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/cap_nhat',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
    ...
    //                     Success
        ...
        $('#tbl_cdtt').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_cdtt').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btninphieutt').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function InPKK(maba){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/phieu_ke_khai_vp/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnlapphieukk').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/phieu_ke_khai_vp/kt_lap_phieu',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
