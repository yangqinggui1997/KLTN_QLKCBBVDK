...
<script>
    $(function () {
        ...
        $('#tbl_pkk').on('click','button[data-button="btnxempkk"]',function(){
            ...
            var url='kham_va_dieu_tri/phieu_ke_khai_vp/in_noi';
        ...
        $('#tbl_pkk').on('click','button[data-button="btnxoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/phieu_ke_khai_vp/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/phieu_ke_khai_vp/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                            $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách tìm kiếm').tooltip('fixTitle').tooltip('show');
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/phieu_ke_khai_vp/lay_ds_all',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
