    ...
    $(function () {
        ...
        $('#btncba').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/cap_cuu/chuyen_ba',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnkotiepnhan').click(function(){
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/cap_cuu/xoa_ba_cn',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btntiepnhan').click(function(){
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/nhan_ba',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnxemtoathuoc').click(function(){
            ...
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xem_toa_thuoc',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnxemketquacls').click(function(){
            ...
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xem_ket_qua_cls',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnxemchidinhtt').click(function(){
            ...
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xem_chi_dinh_tt',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnxemchidinhpt').click(function(){
            ...
            if($('#dsbachotn').children().length > 0){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xem_chi_dinh_pt',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
...
//         Đăng ký kênh kết quả chỉ định thủ thuật 
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_banoi').on('click', 'button[data-button="btnxoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_banoi').on('click','button[data-button="btnsua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bact').on('click', 'button[data-button="btnxemtt"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_noi_tru_ct/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bact').on('click', 'button[data-button="btnxemcdtt"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/lay_ds_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnxemkqcls').click(function (e, maba){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/tra_ket_qua_cls/lay_ket_qua',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnhuygcv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/xoa_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btngcv').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/them_moi_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btningcv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/in_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnhuygrv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_ra_vien/xoa',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btngrv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_ra_vien/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btngiayrv').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_ra_vien/them_moi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                            $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách tìm kiếm').tooltip('fixTitle').tooltip('show');
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/lay_ds_ba',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                        $('#btnlocds').tooltip('hide').attr('data-original-title', 'Lọc danh sách').tooltip('fixTitle').tooltip('show');
        ...
        $('#btnxemctgd').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/lay_ds_ct',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnthemct').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/them_moi_ct',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bact').on('click', 'button[data-button="btnsuact"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/lay_tt_cap_nhat_ct',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btncapnhatct').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_an_noi_tru/cap_nhat_ct',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bact').on('click', 'button[data-button="btnxoact"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/benh_an_noi_tru/xoa_ct',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnthemthuoc').click(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_noi_tru/them_moi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_toathuoc').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_noi_tru_ct/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btncapnhatthuoc').click(function() {
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_noi_tru_ct/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_toathuoc').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/toa_thuoc_noi_tru_ct/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#btnintoathuoc').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_noi_tru/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnhuytoathuoc').click(function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/toa_thuoc_noi_tru/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        function ktcls(maba, macls){
            ...
            return $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/kt_cls_noi_tru',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                     Success
        ...
        $('#btnrachidinhcls').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/lay_ds_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            $.when(ktcls(maba, macls)).then(function (){
                if(flagcls == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/can_lam_sang/them_moi_noi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btnsuacdcls').click(function(){
            ...
            var formData = new FormData();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/can_lam_sang/cap_nhat_noi',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
    ...
    //                     Success
        ...
        $('#tbl_cdcls').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/can_lam_sang/xoa_noi',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_cdcls').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/lay_tt_cap_nhat_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function inphieucls(idcls){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/can_lam_sang/in_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function kttt(mabact, matt){
            ...
            return $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/kt_tt_noi_tru',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            $.when(kttt(maba, matt)).then(function (){
                if(flagtt == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/them_moi_noi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btnsuacdtt').click(function(){
            ...
            var formData = new FormData();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/cap_nhat_noi',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
    ...
    //                     Success
        ...
        $('#tbl_cdtt').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/xoa_noi',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_cdtt').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/lay_tt_cap_nhat_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btninphieutt').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_thu_thuat/in_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function ktpt(mabact, mapt){
            ...
            return $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/kt_pt',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
...
//                     Success
        ...
        $('#btnrachidinhpt').click(function(e, mabact){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            $.when(ktpt(mabact, mapt)).then(function (){
                if(flagpt == true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/them_moi',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        function inphieupt(idpt){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/in',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnsuacdpt').click(function(){
            ...
            var formData = new FormData();
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/cap_nhat',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
    ...
    //                     Success
        ...
        $('#tbl_cdpt').on('click','button[data-button="xoa"]',function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_cdpt').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/chi_dinh_phau_thuat/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        function InPKK(maba){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/phieu_ke_khai_vp/in_noi',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
