    ...
    $(function () {
        ...
        $('#tbl_cd').on('click', 'button[data-button="xoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'hanh_chinh/duyet_van_ban/xoa',
                    xhr: function() {
        ...
        $('#btnduyet').click(function(){
            ...
            $('#proccess').removeClass('hidden');
             ...
             $.ajax({
                 type: 'POST',
                 dataType: "JSON",
                 url: 'hanh_chinh/duyet_van_ban/duyet',
                 xhr: function() {
                     var myXhr = $.ajaxSettings.xhr();
                     return myXhr;
                 },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/duyet_van_ban/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/duyet_van_ban/lay_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
