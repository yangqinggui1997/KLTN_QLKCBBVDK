    ...
    $(function () {
        ...
        $('#tbl_toathuoc').on ('click', 'button[data-button="btnxnlanhthuoc"]', function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/toa_thuoc_ngoai_tru/xac_nhan_lt',
                xhr: function() {
        ...
        $('#btntimkiem').click(function (){
            ...
            var url='kham_va_dieu_tri/toa_thuoc_ngoai_tru/tim_kiem';
            if($('#loaind').val().toString() == 'pt'){
                url='kham_va_dieu_tri/toa_thuoc_ngoai_tru/tim_kiem_nvpt';
            }
            $.ajax({
                type: 'POST',
                dataType: "JSON",
        ...
        $('#btnnapds').click(function(){
            ...
            var formData = new FormData();
            formData.append('_token', CSRF_TOKEN);
            var url='kham_va_dieu_tri/toa_thuoc_ngoai_tru/lay_ds_toa';
            if($('#loaind').val().toString() == 'pt'){
                url='kham_va_dieu_tri/toa_thuoc_ngoai_tru/lay_ds_toa_nvpt';
            }
            $.ajax({
                type: 'POST',
                dataType: "JSON",
