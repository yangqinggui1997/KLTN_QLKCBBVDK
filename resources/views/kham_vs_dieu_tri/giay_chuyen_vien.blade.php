...
<script>
    $(function () {
        ...
        $('#tbl_gcv').on ('click', 'button[data-button="btnxemtt"]', function(){
            ...
            var url='kham_va_dieu_tri/giay_chuyen_vien/them_moi_noi';
            if(loaiba=='ngoai'){
        ...
        $('#tbl_gcv').on('click','button[data-button="btnxoa"]',function(){
            ...
            var loaiba=$(this).attr('data-loaiba');
            var url='kham_va_dieu_tri/giay_chuyen_vien/xoa_noi';
            if(loaiba=='ngoai'){
               ...
               var name='';var arr=[],arr_name=[]
                ...
                if(cf==true){
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'kham_va_dieu_tri/giay_chuyen_vien/xoa_all',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/giay_chuyen_vien/lay_ds_gcv',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
