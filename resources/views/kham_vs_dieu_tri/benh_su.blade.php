...
<script>
    $(function () {
        ...
        $('body').on('click', 'button[data-button="btnxemtt"]', function(){
            ...
            var url='kham_va_dieu_tri/toa_thuoc_noi_tru_ct/lay_ds';
        ...
        $('body').on('click', 'button[data-button="btnxemcdtt"]', function(){
            ...
            formData.append('idba', idba);
            $('#tbl_xemcdtt').html('');
            var url='kham_va_dieu_tri/chi_dinh_thu_thuat/lay_ds_noi';
            if($(this).attr('data-loaiba').toString() == 'ngoai'){
        ...
        $('#tbl_ba').on('click','button[data-button="btnxemctba"]',function(){
            ...
            var url='kham_va_dieu_tri/benh_an_ngoai_tru/lay_tt_cap_nhat';
            if(loaiba== 'noi'){
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'kham_va_dieu_tri/benh_su/xem_benh_su',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
