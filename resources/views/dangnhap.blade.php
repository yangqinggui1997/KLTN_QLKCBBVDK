                        ...
                        <div class="login-form">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="au-input au-input--full" type="email" autocomplete="true" name="email" placeholder="Nhập vào email" value="{{ $tentk }}">
                                </div>
                                <div class="form-group">
                                    <label>Mật khẩu</label>
                                    <input class="au-input au-input--full" type="password" autocomplete="true" name="password" placeholder="Nhập vào mật khẩu" value="{{ $pass }}">
                                </div>
                                @else
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="au-input au-input--full" type="email" autocomplete="true" name="email" placeholder="Nhập vào email">
                                </div>
                                <div class="form-group">
                                    <label>Mật khẩu</label>
                                    <input class="au-input au-input--full" type="password" autocomplete="true" name="password" placeholder="Nhập vào mật khẩu">
                                </div>
                                @endif
                                <div class="row">
                                    <div class="col-lg-1">
