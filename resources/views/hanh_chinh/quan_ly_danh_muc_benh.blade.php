    ...
    $(function () {
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_danh_muc_benh/them_moi',
                xhr: function() {
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_danh_muc_benh/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_benh').on('click', 'button[data-button="xoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'hanh_chinh/quan_ly_danh_muc_benh/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_benh').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_danh_muc_benh/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_danh_muc_benh/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_danh_muc_benh/lay_ds_benh',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
