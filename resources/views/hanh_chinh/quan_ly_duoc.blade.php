    ...
    $(function () {
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_duoc/them_moi',
                xhr: function() {
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_duoc/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_thuoc').on('click', 'button[data-button="xoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'hanh_chinh/quan_ly_duoc/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_thuoc').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_duoc/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_duoc/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'hanh_chinh/quan_ly_duoc/lay_ds_thuoc',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
