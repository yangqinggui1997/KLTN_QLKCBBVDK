...
<script>
    ...
    $(function () {
        ...
        $('#tinh').change(function(){
            ...
            $.ajax({
                type: 'post',
                url: "tiep_don/thong_tin_benh_nhan/lay_ds_huyen",
                dataType: 'JSON',
        ...
        $('#huyen').change(function(){
            ...
            $.ajax({
                type: 'post',
                url: "tiep_don/thong_tin_benh_nhan/lay_ds_xa",
                dataType: 'JSON',
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/them_moi',
                xhr: function() {
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_bn').on('click', 'button[data-button="xoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'tiep_don/thong_tin_benh_nhan/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_bn').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnlocds').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/loc_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_benh_nhan/lay_ds_bn',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
