...
<script>
    $(function () {
        ...
        $('#khoa').change(function(){
            ...
            $.ajax({
                type: 'post',
                url: "tiep_don/dang_ky_kham/lay_ds_phong",
                dataType: 'JSON',
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/them_moi',
                xhr: function() {
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_phieudk').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btntimkiem').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/tim_kiem',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#khoa_f').change(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/loc_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/dang_ky_kham/lay_ds_pdk',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
            ...
            for(var i = 0; i < options.length; i++) {
                ...
                if(option.value === inputValue || option.innerText === inputValue) {
                    ...
                    $.ajax({
                        type: 'POST',
                        dataType: "JSON",
                        url: 'tiep_don/dang_ky_kham/lay_tt_bn',
                        xhr: function() {
                            var myXhr = $.ajaxSettings.xhr();
                            return myXhr;
                        },
