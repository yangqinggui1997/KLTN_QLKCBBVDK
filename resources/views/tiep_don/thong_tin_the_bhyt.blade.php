    ...
    $(function () {
        ...
        $('#btnthem').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_the_bhyt/them_moi',
                xhr: function() {
        ...
        $('#btncapnhat').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_the_bhyt/cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#tbl_thebhyt').on('click', 'button[data-button="xoa"]', function(){
            ...
            if(cf==true){
                ...
                $.ajax({
                    type: 'POST',
                    dataType: "JSON",
                    url: 'tiep_don/thong_tin_the_bhyt/xoa',
                    xhr: function() {
                        var myXhr = $.ajaxSettings.xhr();
                        return myXhr;
                    },
        ...
        $('#tbl_thebhyt').on('click','button[data-button="sua"]',function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_the_bhyt/lay_tt_cap_nhat',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnlocds').click(function (){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_the_bhyt/loc_ds',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
        ...
        $('#btnnapds').click(function(){
            ...
            $.ajax({
                type: 'POST',
                dataType: "JSON",
                url: 'tiep_don/thong_tin_the_bhyt/lay_ds_the_bhyt',
                xhr: function() {
                    var myXhr = $.ajaxSettings.xhr();
                    return myXhr;
                },
